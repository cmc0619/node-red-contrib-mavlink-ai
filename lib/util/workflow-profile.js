 ...
 *   for a bad explicit reference. The unresolved/ambiguous codes come straight
 *   from the connection's strict `resolveProfile()`, matching the connection
 *   outbound contract; the local `PROFILE_UNRESOLVED` guard below only fires
 *   for a degenerate connection lacking `resolveProfile()`.
 */
