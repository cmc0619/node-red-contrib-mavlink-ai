...
/**
 * Back-compat shorthand for a node whose only managed dependency is a required
 * profile. Equivalent to `watchConfigBadge(RED, node, config, { profile:
 * 'required' })`.
 *
 * @param {object} RED     the Node-RED runtime
...
module.exports = { safeDetach, watchProfileBadge, watchConfigBadge };
