...
// Legacy seed list, kept only as the discovery fallback shape for callers that
// pass an explicit `files` list. By default the full upstream definitions
// directory is discovered at the pinned commit instead (#88).
