...
function resolveFieldValue(bundle, value, field) {
  if (Array.isArray(value)) {
    return value.map((v) => coerce64(enumResolver.resolveEnumValue(bundle.enums, v), field));
  }
  return coerce64(enumResolver.resolveEnumValue(bundle.enums, value), field);
}
 ...
 * BigInt and other types" deep in serialization. `double` stays a JS number.
 *
 * @param {*} value
 * @param {MavLinkPacketField} [field]
 * @returns {*}
