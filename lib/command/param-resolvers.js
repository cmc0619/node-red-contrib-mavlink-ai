...
// component type, rather than assuming one table fits every component. Only
// component types with a genuine mode enum are listed; anything else (including
// a plain autopilot) has no entry and yields empty choices, so the editor
// falls back to a safe numeric input rather than mislabelling values.
 ...
 * @param {object} ctx       { firmware, vehicleType, componentType, enums, enumIndex, dialect }
...
module.exports = { resolveParamChoices };
