...
class CommandSend {
   ...
   * @param {string|object} [opts.profile]  profile reference (config-node id)
   *   carried on every send so the connection encodes with that profile's
   *   dialect/identity/signing instead of its default
