...
class CommandSend {
  ...
  constructor(opts = {}) {
    ...
    const resultContext = { dialect: this.dialect, consumer: 'command' };
    this.acceptedResult = requireEnumMember(this.enums, 'MavResult', 'ACCEPTED', resultContext);
    this.inProgressResult = requireEnumMember(this.enums, 'MavResult', 'IN_PROGRESS', resultContext);
