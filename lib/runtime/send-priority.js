...
function clampPriority(value) {
  ...
  /** A whitespace-only string is "left blank", not band 0: Number(' ') is 0,
   * so without the trim a blank text/env override would silently claim the
   * CRITICAL band for routine traffic (Codex review). */
