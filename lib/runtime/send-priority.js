...
const coreValue = coreEnumValues({ consumer: 'send-priority' });
...
const CRITICAL_COMMANDS = new Set([
  ...
  'DO_PARACHUTE'
].map((member) => coreValue('MavCmd', member)));
...
module.exports = { PRIORITY, commandPriority, commandPriorityFor, clampPriority };
