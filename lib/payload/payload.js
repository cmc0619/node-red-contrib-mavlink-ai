...
const BUILDERS = {
  ...
  /** Arm, disarm, or release a parachute (MAV_CMD_DO_PARACHUTE). */
  parachute(opts) {
    return command('MAV_CMD_DO_PARACHUTE', {
      param1: resolveAction(PARACHUTE_ACTIONS, opts.parachuteAction || 'release', 'BAD_PARACHUTE_ACTION', 'Parachute action')
    });
  },
