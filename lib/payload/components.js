...
const coreValue = coreEnumValues({ consumer: 'payload-components' });
...
const MAV_COMP_ID = Object.fromEntries(
  ['AUTOPILOT1', 'CAMERA', 'GIMBAL'].map((member) => [member, coreValue('MavComponent', member)])
);
